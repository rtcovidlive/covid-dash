function ConstantsInternal() {
  ...
  this.MetricOptions = {
    ...
    DerivedR0NoUI: "Infection rate no UI",
    TrueInfections: "True infections",
    TrueInfectionsNoUI: "True infections no UI",
    TrueInfectionsPC: "True infections per 100k",
    TrueInfectionsPCNoUI: "True infections per 100k no UI",
    Seroprevalence: "Seroprevalence",
    SeroprevalenceNoUI: "Seroprevalence no UI",
  };
  this.CompareMode = {
    Cases: {
      label: "Cases",

  ...
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to Rt Live.
          </p>
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to Rt Live, accessible from
          https://rt.live
        </li>{" "}
        <li>
      ...
      <p>
        ...
        Light law, You can contact Us using the contact information provided
        below.
      </p>
